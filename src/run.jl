...
for cellpath ∈ cellpaths
    println("Processing $cellpath")
    localizations = LocalizationMicroscopy.load(cellpath, LocalizationMicroscopy.nikonelementstext)

    ch1_molecules, ch1_localizations = StormAnalysis.getmolecules(localizations, ch1_name, ch1_startframe, ch1_frames, ch1_starttrim, ch1_endtrim, maximum_displacement, t_off, merge_radius)
    ch2_molecules, ch2_localizations = StormAnalysis.getmolecules(localizations, ch2_name, ch2_startframe, ch2_frames, ch2_starttrim, ch2_endtrim, maximum_displacement, t_off, merge_radius)
