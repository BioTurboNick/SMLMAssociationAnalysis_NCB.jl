...
plot!(xvals, mean_average_percentileranks, line=(stroke(10), :black), yaxis=(0:1), xaxis=(0:400:2000), tickfontsize=96, legend=:none, size=(1024,2048), left_margin=20mm, top_margin=5mm, right_margin=10mm, bottom_margin=6mm, ywiden=false)
...
plot!(xvals, mean_ch1_frac, line=(stroke(10), :black), yaxis=(0:1), xaxis=(0:1000:5000), tickfontsize=96, legend=:none, size=(1024,2048), left_margin=17mm, top_margin=5mm, right_margin=10mm, bottom_margin=4mm, ywiden=false)
...
plot!(xvals, mean_ch2_frac, line=(stroke(10), :black), yaxis=(0:1), xaxis=(0:1000:5000), tickfontsize=96, legend=:none, size=(1024,2048), left_margin=17mm, top_margin=5mm, bottom_margin=4mm, right_margin=10mm, ywiden=false)
